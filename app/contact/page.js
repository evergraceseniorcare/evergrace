      ...
      <section style={{padding:'3rem 5rem 5rem',maxWidth:'1100px',margin:'0 auto',display:'grid',gridTemplateColumns:'1fr 1.4fr',gap:'4rem',alignItems:'start'}}>
          ...
          {[
            {
              label:'Phone', zh:'电话',
              value:'(949) 555-0188',
              note:'Mon–Sat 8am–7pm · Sun 9am–5pm',
            },
            {
              label:'WeChat', zh:'微信',
              value:'EverGraceCare',
              note:'Scan our QR code or search ID above',
            },
            {
              label:'Email', zh:'电子邮件',
              value:'hello@evergracecare.com',
              note:'We respond within 4 business hours',
            },
            {
              label:'Address', zh:'地址',
              value:'2600 Michelson Dr, Suite 1700',
              note:'Irvine, CA 92612',
            },
          ].map(c=>(
        ...
        <div style={{background:'var(--sage-lt)',borderRadius:'20px',padding:'2.5rem',border:'1px solid var(--border)'}}>
          ...
          <div style={{display:'flex',flexDirection:'column',gap:'1.25rem'}}>
            ...
            <button style={{width:'100%',background:'var(--sage)',color:'white',border:'none',padding:'14px',borderRadius:'10px',fontSize:'16px',fontWeight:500,cursor:'pointer',transition:'background .2s'}}
              onMouseOver={e=>e.target.style.background='var(--sage-dk)'}
              onMouseOut={e=>e.target.style.background='var(--sage)'}>
              Send Request 发送咨询
            </button>
